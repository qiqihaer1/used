 ...
 */
public class BlankSpout extends BaseRichSpout{
    //发送的数据
    String[] datas=new String[]{"go pikapika","c++ miaomiao","python pikapika","java pikapika"};
...
//        collector.emit(list);
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        ...
        outputFieldsDeclarer.declare(new Fields("efsefas"));
    }
}
